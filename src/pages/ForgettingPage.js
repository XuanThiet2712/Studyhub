...
export class ForgettingPage {
  ...
  render() {
    ...
    <div class="page">
      ...
      <div id="fp-curve">
        <div style="display:grid;grid-template-columns:1fr 280px;gap:20px">
          <div style="background:var(--white);border:1px solid var(--border);border-radius:var(--r-lg);padding:18px;box-shadow:var(--shadow-sm)">
    ...
    <div class="overlay" id="addTopicModal"><div class="modal modal-sm">
